...
function HeaderSection() {
  return (
    <motion.div
      className="box-border content-stretch flex flex-col gap-4 sm:gap-6 items-center justify-start leading-[0] not-italic p-0 relative shrink-0 text-left w-full max-w-6xl mx-auto px-4 sm:px-6"
    ...
    >
      <motion.div 
        className="capitalize font-['Poppins:SemiBold',_sans-serif] relative shrink-0 text-[#ffffff] text-center w-full"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
      >
        <p className="block leading-[1.2] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[54px]">Build Immediate Credibility</p>
      </motion.div>
      <motion.div 
        className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[#aaaaaa] text-center w-full max-w-4xl mx-auto"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8, delay: 0.4, ease: "easeOut" }}
      >
        <p className="leading-[1.6] text-sm sm:text-base md:text-lg lg:text-xl">
...
function FeatureInfo() {
  return (
    <div
      className="flex-1 box-border content-stretch flex flex-col gap-4 sm:gap-6 items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-left text-center sm:text-left"
      data-name="Feature Info"
    >
      <div className="capitalize font-['Poppins:Medium',_sans-serif] relative shrink-0 text-[#ffffff] w-full">
        <p className="block leading-[1.4] text-base sm:text-lg lg:text-[20px]">Headshot, Role, Bio, Contact Info</p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[#bebebe] tracking-[0.6px] w-full">
        <p className="block leading-[1.5] text-sm sm:text-[15px]">
...
function FeatureImage() {
  return (
    <div
      className="flex-1 sm:flex-none box-border content-stretch flex flex-col gap-[6.388px] items-center justify-end p-0 relative shrink-0 max-w-[200px] mx-auto sm:mx-0"
      data-name="Feature Image"
    >
      <motion.div
        className="bg-[50%_31.24%] bg-no-repeat bg-size-[260.47%_138.6%] h-[200px] sm:h-[240px] lg:h-[304px] rounded-tl-[30px] rounded-tr-[30px] shrink-0 w-[140px] sm:w-[160px] lg:w-[181px]"
...
function FeatureColumn() {
  return (
    <motion.div
      className="flex-1 bg-[#120b19] h-auto min-h-[280px] sm:min-h-[320px] lg:h-[328px] relative rounded-[15px] shrink-0"
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col sm:flex-row gap-4 sm:gap-6 h-full items-start justify-start p-4 sm:p-6 relative w-full">
          <FeatureInfo />
          <FeatureImage />
        </div>
      </div>
...
function FeatureInfo1() {
  return (
    ...
    >
      <div className="capitalize font-['Poppins:Medium',_sans-serif] relative shrink-0 text-[#ffffff] w-full">
        <p className="block leading-[1.4] text-base sm:text-lg lg:text-[20px]">
          Past Project Gallery, Licenses, Certifications
        </p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[#bebebe] tracking-[0.6px] w-full">
        <p className="block leading-[1.5] text-sm sm:text-[15px]">{`Showcase successfully completed projects with high-quality images and videos. Display critical credentials like licenses, insurance, and industry certifications to build immediate trust. `}</p>
      </div>
    </div>
  );
}
...
function FeatureImage1() {
  return (
    <div
      className="flex-1 sm:flex-none box-border content-stretch flex flex-row gap-[8.762px] items-center justify-center p-0 relative shrink-0 max-w-[240px] mx-auto sm:mx-0"
      data-name="Feature Image"
    >
      <motion.div
        className="bg-center bg-cover bg-no-repeat h-[150px] sm:h-[180px] lg:h-[217px] shrink-0 w-[150px] sm:w-[180px] lg:w-[205px] rounded-lg"
        data-name="Portfolio Gallery"
...
function FeatureColumn1() {
  return (
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col sm:flex-row gap-4 sm:gap-8 h-full items-start justify-start p-4 sm:p-6 relative w-full">
          <FeatureInfo1 />
          <FeatureImage1 />
        </div>
      </div>
...
function FeatureRow() {
  return (
    <div
      className="box-border content-stretch flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch justify-start p-0 relative shrink-0 w-full max-w-6xl mx-auto px-4 sm:px-6"
...
function FeatureInfo2() {
  return (
    ...
    >
      <div className="capitalize font-['Poppins:Medium',_sans-serif] relative shrink-0 text-[#ffffff] w-full">
        <p className="block leading-[1.4] text-base sm:text-lg lg:text-[20px]">{`Embedded Google Reviews and "About Me" Videos`}</p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[#bebebe] tracking-[0.6px] w-full">
        <p className="block leading-[1.5] text-sm sm:text-[15px]">{`Feature glowing reviews from satisfied clients for authenticity. Include a short, personable video where the sales rep introduces themselves and your company's values.`}</p>
      </div>
    </div>
  );
}
...
function FeatureImage2() {
  return (
    ...
    >
      <motion.div
        className="bg-center bg-cover bg-no-repeat h-[140px] sm:h-[170px] lg:h-[198px] shrink-0 w-[140px] sm:w-[170px] lg:w-48 rounded-lg"
        data-name="Google Reviews"
...
function FeatureColumn2() {
  return (
    <motion.div
      className="bg-[#120b19] box-border content-stretch flex flex-col sm:flex-row gap-4 sm:gap-8 h-auto min-h-[280px] sm:min-h-[320px] lg:h-full items-start justify-start overflow-clip p-4 sm:p-6 relative rounded-[15px] shrink-0 w-full"
      data-name="Feature Column"
      style={{
        backgroundImage:
          "linear-gradient(0deg, rgba(0, 123, 255, 0.25) 0%, rgba(0, 123, 255, 0) 100%), linear-gradient(90deg, rgb(18, 11, 25) 0%, rgb(18, 11, 25) 100%)",
...
function FeatureRow1() {
  return (
    <div
      className="box-border content-stretch flex flex-col lg:flex-row-reverse gap-6 lg:gap-8 items-stretch justify-center p-0 relative shrink-0 w-full max-w-6xl mx-auto px-4 sm:px-6"
      data-name="Feature Row"
    >
      <div className="flex flex-row items-stretch order-2 lg:order-2 self-stretch">
        <FeatureColumn2 />
      </div>
      <div className="flex flex-row items-stretch order-1 lg:order-1 self-stretch">
        <FeatureColumn3 />
      </div>
    </div>
  );
...
function ContentContainer() {
  return (
    ...
    >
      ...
      <FeaturesSection />
      <motion.div 
        className="font-['Poppins:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#aaaaaa] text-[20px] text-left w-[1126px]"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
...
export function BuildCredibilitySection() {
  return (
    <div className="relative w-full bg-[#020203]" data-name="Container">
      <div className="flex flex-col items-center justify-center relative w-full">
        <motion.div 
          className="box-border content-stretch flex flex-col gap-8 sm:gap-12 lg:gap-16 items-start justify-start px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative w-full max-w-7xl mx-auto"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true, margin: "-10%" }}
